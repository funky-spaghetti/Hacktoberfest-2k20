...
class TestSchoolClass(unittest.TestCase):
    ...
    def test_make_groups_disconnected_friendships(self):
        r"""Test make_groups with two disconnected groups of friends.
    ...
    def test_print_groups_solution(self):
    ...
    def test_print_groups_error(self):
        """Test print_groups with no valid solution (all friends).
